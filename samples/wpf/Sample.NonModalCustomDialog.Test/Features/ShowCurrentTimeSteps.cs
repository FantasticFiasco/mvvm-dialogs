...
using Sample.NonModalCustomDialog.ScreenObjects;
...
namespace Sample.NonModalCustomDialog.Features
{
    [Binding]
    public class ShowCurrentTimeSteps : FeatureSteps<MainScreen>
    {
        ...
        protected override Application LaunchApplication()
        {
            ...
            string applicationFilePath = Path.Combine(
                ...
                "Sample.NonModalCustomDialog.exe");
        ...
        {
            return ScreenRepository.Get<MainScreen>("Sample - Non-Modal Custom Dialog", InitializeOption.NoCache);
        }
