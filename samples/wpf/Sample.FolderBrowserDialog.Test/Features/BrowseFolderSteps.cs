...
using Sample.FolderBrowserDialog.ScreenObjects;
...
namespace Sample.FolderBrowserDialog.Features
{
    [Binding]
    public class BrowseFolderSteps : FeatureSteps<MainScreen>
    {
        ...
        protected override Application LaunchApplication()
        {
            ...
            string applicationFilePath = Path.Combine(
                ...
                "Sample.FolderBrowserDialog.exe");
        ...
        {
            return screenRepository.Get<MainScreen>("Sample - Folder Browser Dialog", InitializeOption.NoCache);
        }
