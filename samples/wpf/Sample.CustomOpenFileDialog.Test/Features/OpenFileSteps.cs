...
using Sample.CustomOpenFileDialog.ScreenObjects;
...
namespace Sample.CustomOpenFileDialog.Features
{
    [Binding]
    public class OpenFileSteps : FeatureSteps<MainScreen>
    {
        ...
        protected override Application LaunchApplication()
        {
            ...
            string applicationFilePath = Path.Combine(
                ...
                "Sample.CustomOpenFileDialog.exe");
        ...
        {
            return ScreenRepository.Get<MainScreen>("Sample - Custom Open File Dialog", InitializeOption.NoCache);
        }
