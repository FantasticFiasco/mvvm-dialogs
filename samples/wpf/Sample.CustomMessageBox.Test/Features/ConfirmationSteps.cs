...
using Sample.CustomMessageBox.ScreenObjects;
...
namespace Sample.CustomMessageBox.Features
{
    [Binding]
    public class ConfirmationSteps : FeatureSteps<MainScreen>
    {
        ...
        {
            return ScreenRepository.Get<MainScreen>("Sample - Custom Message Box", InitializeOption.NoCache);
        }
