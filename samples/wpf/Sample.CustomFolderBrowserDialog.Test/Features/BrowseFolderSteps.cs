...
using Sample.CustomFolderBrowserDialog.ScreenObjects;
...
namespace Sample.CustomFolderBrowserDialog.Features
{
    [Binding]
    public class BrowseFolderSteps : FeatureSteps<MainScreen>
    {
        ...
        protected override Application LaunchApplication()
        {
            ...
            string applicationFilePath = Path.Combine(
                ...
                "Sample.CustomFolderBrowserDialog.exe");
        ...
        {
            return screenRepository.Get<MainScreen>("Sample - Custom Folder Browser Dialog", InitializeOption.NoCache);
        }
