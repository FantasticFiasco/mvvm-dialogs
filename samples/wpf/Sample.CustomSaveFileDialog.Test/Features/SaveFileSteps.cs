...
using Sample.CustomSaveFileDialog.ScreenObjects;
...
namespace Sample.CustomSaveFileDialog.Features
{
    [Binding]
    public class SaveFileSteps : FeatureSteps<MainScreen>
    {
        ...
        protected override Application LaunchApplication()
        {
            ...
            string applicationFilePath = Path.Combine(
                ...
                "Sample.CustomSaveFileDialog.exe");
        ...
        {
            return ScreenRepository.Get<MainScreen>("Sample - Custom Save File Dialog", InitializeOption.NoCache);
        }
