...
using Sample.ModalDialog.ScreenObjects;
...
namespace Sample.ModalDialog.Features
{
    [Binding]
    public class AddTextSteps : FeatureSteps<MainScreen>
    {
        ...
        {
            return ScreenRepository.Get<MainScreen>("Sample - Modal Dialog", InitializeOption.NoCache);
        }
