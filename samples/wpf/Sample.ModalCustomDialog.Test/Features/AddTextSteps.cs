...
using Sample.ModalCustomDialog.ScreenObjects;
...
namespace Sample.ModalCustomDialog.Features
{
    [Binding]
    public class AddTextSteps : FeatureSteps<MainScreen>
    {
        ...
        {
            return ScreenRepository.Get<MainScreen>("Sample - Modal Custom Dialog", InitializeOption.NoCache);
        }
